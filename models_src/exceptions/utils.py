...
from models_src.exceptions.exception_constants import (
    ...
    MISSING_API_KEY_USER_ID_LOG_MESSAGE, MISSING_LABEL_ID_TITLE,
    MISSING_LABEL_LOG_MESSAGE,
    MISSING_USER_ID_LOG_MESSAGE,
    MISSING_USER_ID_TITLE,
    REPO_ALREADY_EXISTS_MESSAGE, REPO_ALREADY_EXISTS_TITLE,
    REPOSITORY_DOESNT_EXIST_MESSAGE,
    REPOSITORY_DOESNT_EXIST_TITLE,
)


def internal_error(log_message: str, error_type: str, log_level = logging.FATAL, **kwargs):
